...
function RestablecerPasswordAdminForm() {
  ...
  if (listo) {
    return (
      <div className="text-center flex flex-col items-center gap-3">
        ...
        <Button className="mt-2" onClick={() => router.push("/login/admin")}>
          Ir a iniciar sesión
        </Button>
      </div>
    );
  ...
  return (
    <>
      <div className="flex items-center gap-2 mb-1 text-ink-900">
        ...
        <h1 className="font-display text-2xl font-semibold">Elige tu nueva contraseña</h1>
      </div>
...
export default function RestablecerPasswordAdminPage() {
  return (
    <div className="mx-auto max-w-md px-4 py-20">
      <Card className="p-8">
        <Suspense fallback={null}>
          <RestablecerPasswordAdminForm />
        </Suspense>
      </Card>
    </div>
  );
