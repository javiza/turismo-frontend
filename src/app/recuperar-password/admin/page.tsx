...
export default function RecuperarPasswordAdminPage() {
      ...
      <Card className="p-8">
        {enviado ? (
          <div className="text-center flex flex-col items-center gap-3">
            ...
            <Link href="/login/admin" className="text-clay-600 font-medium hover:underline text-sm mt-2">
          ...
          <>
            <div className="flex items-center gap-2 mb-1 text-ink-900">
              ...
              <h1 className="font-display text-2xl font-semibold">Recupera tu contraseña</h1>
            </div>
            <p className="text-sm text-ink-600 mb-6">
              Ingresa tu email de administrador y te enviaremos un enlace para restablecerla.
            </p>
            ...
            <p className="mt-6 text-sm text-ink-600 text-center">
              <Link href="/login/admin" className="text-clay-600 font-medium hover:underline">
                Volver a iniciar sesión
              </Link>
            </p>
          </>
