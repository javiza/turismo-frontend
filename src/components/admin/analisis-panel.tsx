...
/**
 * Estadísticas de visitas, reservas y tendencias (antes "Big data",
 * ahora "Análisis"). Vive dentro de Finanzas > Administración, detrás
 * del candado de contraseña (ver components/admin/administracion-panel).
 */
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="font-display text-xl font-semibold text-ink-900">Análisis</h2>
